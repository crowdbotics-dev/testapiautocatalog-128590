...
## Project Structure
    ...
    ├── testapiautocatalog_128590  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_128590`
...
2. Clone this repo and `cd testapiautocatalog_128590`
